...
#import "IDESourceLanguageServiceSwiftDiagnosticItems-Protocol.h"

struct CDStruct_3b0d17db;
...
@property id interfaceGenerationToken;
@property(copy) NSString *sourceKitBufferName;
@property(retain) id <IDESourceLanguageServiceSwiftDiagnosticItems> diagnosticItems;
